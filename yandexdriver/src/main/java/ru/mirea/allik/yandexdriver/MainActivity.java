package ru.mirea.allik.yandexdriver;
...
import ru.mirea.allik.yandexdriver.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity  implements DrivingSession.DrivingRouteListener{
    ...
    private final Point ROUTE_START_LOCATION = new Point(55.705001, 37.922335);
    private final Point ROUTE_END_LOCATION = new Point(55.790120, 37.530953);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PlacemarkMapObject marker = mapView.getMap().getMapObjects().addPlacemark(new
                Point(55.790120, 37.530953), ImageProvider.fromResource(this, R.drawable.icon2));
        marker.addTapListener(new MapObjectTapListener() {
            @Override
            public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point
                    point) {
                Toast.makeText(getApplication(),"Авиапарк: \n" +
